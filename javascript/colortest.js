...
function cube_row_part(n) {
    for (let i = n; i < n + 6; i++) color_cell(i)
}
...
for (let i = 0; i < 16; i++) color_cell(i)
process.stdout.write('\u001b[0m\n\n')

// Print the 6 sides of the color cube - these are more standardized
// but the order is a bit odd, thus the need for the above trickery
for (let i = 16; i < 52; i+=6) cube_row(i)
process.stdout.write('\n')
for (let i = 124; i < 160; i+=6) cube_row(i)
process.stdout.write('\n')

// Finally, the 24 grays
for (let i = 232; i < 256; i++) color_cell(i)
process.stdout.write('\u001b[0m\n\n')
