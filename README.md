...
So far, I've implemented it in C, POSIX Shell, Python 3, Javascript (Node.js), Perl, Rust, Ruby, Java, C#, PowerShell Core, and Brainfuck. Future plans include x86_64 Assembly with Linux syscalls, Go, Oil, elvish, and possibly C++.
