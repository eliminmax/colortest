...
For instructions on how to run any specific implementation on Debian GNU/Linux 13 (Trixie), see HOW_TO_RUN.md. All languages have been run in a Debian 13 Podman container with the instructions in that document.
